...
<head>
	<title>Log in</title>
	<link rel="stylesheet" type="text/css" href="/Ejercicio3/hojadeestilos.css">
</head>
<body <?php echo "style='background-color:$color';font-family: Arial, Helvetica, sans-serif; color: #ffffff;";?> >
    ...
    <div style="font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; 
            ...
            <a href='/Ejercicio3'>INICIO</a><br>
			<a href='/Ejercicio3/informatica/'>informatica</a><br>
			<a href='/Ejercicio3/matematica'>matematica</a><br>
			<a href='/Ejercicio3/fisica/'>fisica</a><br>
	</div>
    <div style="font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; 
            color: #ffffff; 
            font-size: 18px; 
