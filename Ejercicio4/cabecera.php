...
<head>
	<title>Log in</title>
	<link rel="stylesheet" type="text/css" href="/Ejercicio4/hojadeestilos.css">
</head>
<body <?php echo "style='background-color:$color';font-family: Arial, Helvetica, sans-serif; color: #ffffff;";?> >
    ...
    <div style="font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; 
            ...
            <a href='/Ejercicio4'>INICIO</a><br>
			<a href='/Ejercicio4/informatica/'>informatica</a><br>
			<a href='/Ejercicio4/matematica'>matematica</a><br>
			<a href='/Ejercicio4/fisica/'>fisica</a><br>
	</div>
    <div style="font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; 
            color: #ffffff; 
            font-size: 18px; 
