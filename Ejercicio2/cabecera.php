...
<head>
	<title>Log in</title>
	<link rel="stylesheet" type="text/css" href="/Ejercicio2/hojadeestilos.css">
</head>
<body <?php echo "style='background-color:$color';font-family: Arial, Helvetica, sans-serif; color: #ffffff;";?> >
    ...
    <div style="font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; 
            ...
            <a href='/Ejercicio2'>INICIO</a><br>
			<a href='/Ejercicio2/informatica/'>informatica</a><br>
			<a href='/Ejercicio2/matematica'>matematica</a><br>
			<a href='/Ejercicio2/fisica/'>fisica</a><br>
	</div>
    <div style="font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif; 
            color: #ffffff; 
            font-size: 18px; 
